            ...
            <div class="px-4 py-4 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ url('update-student/'.$student->id) }}">
                    ...
                    <div class="mb3 mt-4">
                        ...
                        <x-input id="name" class="block mt-1 w-full" type="text" name="name" :value="$student->name"  autofocus />
                    </div>
                    ...
                    <div class="mb3 mt-4">
                        ...
                        <x-input id="email" class="block mt-1 w-full" type="text" name="phone" :value="$student->phone" autofocus />
                    </div>
